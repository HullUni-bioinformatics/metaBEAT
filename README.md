...
Reproducable pipeline for the analyses of metabarcoding data generated by either Sanger or NGS approaches.


```bash
usage: metaBEAT.py [-h] [-Q <FILE>] [-v] [-s] [-f] [-p] [-t] [-b]
                   [-m <string>] [-n <INT>] [-E] [-e] [--trim_adapter <FILE>]
                   [--trim_qual <INT>] [--trim_window <INT>]
                   [--trim_minlength <INT>] [--merge] [--product_length <INT>]
                   [--phred <INT>] [-R <FILE>] [--gb_out <FILE>] [--rec_check]
                   [--clust_match <FLOAT>] [--clust_cov <INT>] [--www]
                   [--min_ident <FLOAT>] [--min_bit <INT>] [--version]
